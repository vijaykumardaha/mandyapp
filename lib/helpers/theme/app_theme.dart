...
class AppTheme {
  ...
  static ThemeData employeeCommunication = AppTheme.themeType == ThemeType.light
      ? employeeCommunicationLightTheme
      : employeeCommunicationDarkTheme;

  static ThemeData employeeCommunicationLightTheme = createTheme(
    ColorScheme.fromSeed(
      seedColor: Color(0xff9A3B3B),
      primary: Color(0xff9A3B3B),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff9A3B3B),
      error: Color(0xffFF0000),
      surface: Color(0xffffffff),
      onSurface: Color(0xffffffff),
    ),
  );
  static ThemeData employeeCommunicationDarkTheme = createTheme(
    ColorScheme.fromSeed(
      seedColor: Color(0xff9A3B3B),
      primary: Color(0xff9A3B3B),
      onPrimary: Color(0xffffffff),
  ...
  static resetThemeData() {
    ...
    plantTheme = AppTheme.themeType == ThemeType.light
        ? plantLightTheme
        : plantDarkTheme;
