...
class ConnectedPrinterCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final hasConnection =
        bluetoothEnabled && connected && (connectedMac?.isNotEmpty ?? false);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const MyText.bodyLarge('Connected Printer:', fontWeight: 600),
          MySpacing.height(8),
          if (hasConnection) ...[
            MyText.bodyMedium(connectedDevice.name, fontWeight: 600),
            MySpacing.height(4),
            MyText.bodySmall('MAC: ${connectedDevice.macAdress}',
            ...
            Align(
              ...
              child: OutlinedButton.icon(
                ...
                label: const MyText.bodySmall('Disconnect', fontWeight: 600),
              ),
            ),
          ] else ...[
            MyText.bodyMedium(
